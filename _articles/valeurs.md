...
## Pourquoi?
Acquérir un bagage technique n'est pas le plus difficile. Les cursus de formation (en ligne ou en présentiel), les articles et les tutos sont partout. 
...
* Avez-vous une idée des équipements dont disposent les utilisauteurs ? [Performance Inequality Gap [EN]](https://infrequently.org/series/performance-inequality/)
* On se pose de plus en plus la question des biais de certains algorithmes. On s'interroge aussi sur les utilisations possibles de la reconnaissance faciale. Et si les biais vous empêchez d'utiliser certains outils? [Les biais des algorithmes [EN]](https://www.ted.com/talks/joy_buolamwini_how_i_m_fighting_bias_in_algorithms?language=fr)
* Que peut faire un développeur contre l'urgence climatique? Demandez-vous plutôt ce que vous devez faire à ce sujet (et on verra bientôt comment le faire). [Les devoirs du développeur contre l'urgence climatique [EN]](https://blog.m7w3.de/responsibility-of-a-developer-climate-change.html)
* [L'accessibilité et la performance ne sont pas des bonus mais la base [EN]](https://css-tricks.com/accessibility-and-web-performance-are-not-features-theyre-the-baseline/). Et c'est à mon avis pareil pour la sécurité, l'éthique, l'éco-conception ainsi que la façon dont on traite les données personnelles. 

## Aborder les valeurs
On s'intéresse ici aux domaines suivants :
* Accessibilité
* Performance
* Sécurité
* Données personnelles
* Eco-conception
* Ethique (et mécanismes déceptifs)

L'objectif est pour chacun d'entre eux de :
* resituer le contexte, en quoi il est essentiel
...
* présenter les bénéfices attendus. Pas les bénéfices directs (les plus évidents) mais plutôt les effets de bord. Par exemple : travailler sur l'accessibilité améliore le référencement naturel.     
   
On peut en venir à se demander pourquoi toutes ces bonnes pratiques ne sont pas systématiquement respectées. Il y a plusieurs réponses possibles mais, à mon sens, la réponse tourne autour de plusieurs préjugés : 
...
* on minimise les conséquences du fait de ne pas les suivre. [Exemple pour la sécurité qui marche aussi pour les autres valeurs [EN]](https://danielmiessler.com/blog/the-reason-software-remains-insecure/).    
...
En résumé, un développeur n'est pas condamné à écrire du code dans son coin (avec ou sans IA). Il doit prendre conscience de l'impact qu'il peut avoir sur le monde et du poids de ses choix (ainsi que des choix qu'il refuse de faire).    
