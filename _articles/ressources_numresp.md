...
excerpt: Avoir les bonnes ressources et outils pour une meilleure utilisation du numérique
---
...
Et si le sujet du Numérique Responsable vous intéresse, vous trouverez d'autres ressources [ici](/categories/numeriqueresponsable).
...
* [Mon article sur le sujet]({% link _articles/design-persuasif.md %})
